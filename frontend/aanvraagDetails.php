...
<div class="main">
    <div class="payment-content">
        ...
        if (isset($_GET['id'])) {
            ...
            $sql = "SELECT route FROM Aanvragen WHERE id = $paymentId";
            ...
            if ($result !== false && $result->num_rows > 0) {
                ...
                $allRoutes = array('Verstuurd', 'Ontvangen', 'In behandeling', 'Geaccepteerd');

                // Toon de kop van de tabel
                echo "<h1>Track & Trace</h1>";
                echo "<p>De aanvraag is <strong>$selectedRoute</strong>.</p>";
                echo "<ul>";
